"""Email Campaign Agent - Main Agent Implementation."""
...
class EmailCampaignAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "design_campaign": self.tools.design_campaign,
            "personalize_emails": self.tools.personalize_emails,
            "manage_subscribers": self.tools.manage_subscribers,
            "optimize_send_time": self.tools.optimize_send_time,
            "analyze_campaign": self.tools.analyze_campaign,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['email', 'campaign', 'analytics', 'optimization'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "personalize_emails": ['personalize', 'emails'],
            "manage_subscribers": ['manage', 'subscribers'],
            "optimize_send_time": ['optimize', 'send', 'time'],

"""Email Campaign Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Email campaign agent that designs email sequences, personalizes content with merge fields, manages subscriber lists, optimizes send times, and analyzes campaign performance.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
